...
st.title(APP_TITLE)
st.caption("Dashboard interactivo para analizar artículos científicos de Scopus sobre Instagram, adolescentes, redes sociales y autoestima.")
...
with tab1:
    ...
    with c5:
        ...
        st.plotly_chart(fig, use_container_width=True)
    with c6:
        st.info("La producción por año permite ver la actualidad del tema, mientras que las citas ayudan a reconocer los años con mayor impacto académico.")
...
with tab2:
    ...
    st.markdown(
        "Estos gráficos se conectan directamente con la pregunta de investigación, porque muestran qué tan presentes están los conceptos de Instagram, adolescentes, redes sociales, autoestima, imagen corporal y salud mental en los títulos, abstracts y keywords."
    )
